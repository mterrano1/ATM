...
RSpec.describe "Sessions", type: :request do
  let!(:user) { User.create(username: "test_user", password: "sup3r-secret", password_confirmation: "sup3r-secret", first_name: "John", last_name: "Doe", email: "johndoe@gmail.com") }
