...
RSpec.describe "Users", type: :request do
  ...
  describe "GET /me" do
    let!(:user1) { User.create(username: "test_user_2", password: "sup3r-secret", first_name: "John", last_name: "Doe", email: "johndoe@gmail.com") }
    let!(:user2) { User.create(username: "test_user_1", password: "sup3r-secret", first_name: "John", last_name: "Doe", email: "johndoe@gmail.com") }
